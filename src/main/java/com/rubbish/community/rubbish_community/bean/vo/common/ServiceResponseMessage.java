package com.rubbish.community.rubbish_community.bean.vo.common;
...
public class ServiceResponseMessage<T> implements Serializable {
    ...
    public static ServiceResponseMessage createBySuccessCodeMessage(){
        ...
        serviceResponseMessage.meta = new Meta(ResultCodeEnum.SUCCESS_NO_CONTENT,"SUCCESS");
        return serviceResponseMessage;
    }

    public static ServiceResponseMessage createBySuccessCodeMessage(String msg){
        ServiceResponseMessage serviceResponseMessage = new ServiceResponseMessage();
        serviceResponseMessage.meta = new Meta(ResultCodeEnum.SUCCESS_NO_CONTENT,msg);
        return serviceResponseMessage;
    }

    public static <T> ServiceResponseMessage createBySuccessCodeMessage(T data){
        ServiceResponseMessage serviceResponseMessage = new ServiceResponseMessage();
        serviceResponseMessage.meta = new Meta(ResultCodeEnum.SUCCESS,"SUCCESS");
    ...
    public static  <T> ServiceResponseMessage createBySuccessCodeMessage(String msg, T data){
        ServiceResponseMessage serviceResponseMessage = new ServiceResponseMessage();
        serviceResponseMessage.meta = new Meta(ResultCodeEnum.SUCCESS,msg);
        serviceResponseMessage.data = data;
        return serviceResponseMessage;
    }
    ...
    public static ServiceResponseMessage createByFailCodeMessage(String msg){
        ServiceResponseMessage serviceResponseMessage = new ServiceResponseMessage();
        serviceResponseMessage.meta = new Meta(ResultCodeEnum.BAD_REQUEST,msg);
        return serviceResponseMessage;
    }
    ...
    private static class Meta{
        ...
        private Meta(ResultCodeEnum resultCode, String message) {
